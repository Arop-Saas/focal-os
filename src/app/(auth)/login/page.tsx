  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/register" className="font-medium text-blue-600 hover:underline">Start free trial</Link>
      </p>
    </div>
  );
}
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><Loader2 className="h-6 w-6 animate-spin text-blue-600" /></div>}>
      <LoginContent />
    </Suspense>
  );
}
