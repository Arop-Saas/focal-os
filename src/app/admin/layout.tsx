...
import { LayoutDashboard, Building2, Megaphone, ShieldAlert, LogOut, Lightbulb, Monitor } from "lucide-react";
...
const navItems = [
  ...
  { label: "Window View", href: "/admin/window-view", icon: Monitor },
];
